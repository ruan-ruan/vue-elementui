...
const cn = {
    ...
    Public:{//公共部分
    	...
    	selDeviceZ:'请选择Z端设备',
    	selPort:'请选择设备端口',
    	a_zEqual:'A,Z两端IP不能相同,请重新输入!',
    	NoIp:'两个设备ip不能相同，请重新输入！',
    	plaSureIp:'请输入ip',
    	vlanLen:'valn区间只能是在2~4094',
    	accountRole:'账户角色',
    	accountName:'账户名称',
    	fullName:"姓名",
    	sendCodeIphone:'请发送验证码到手机',
    	iphoneCode:'手机验证码',
    	newIphone:'新手机号码',
    	sendEmailCode:'请发送验证码到邮箱',
    	emailCode:'邮箱验证码',
    	newEmail:'新邮箱',
		newIphoneReset:'新旧手机号不能一致，请重新输入!',
		newEmailReset:'新旧邮箱不能一致，请重新输入!',
		iphoneEdit:'手机号修改',
		emailEdit:'邮箱修改',
		Authentication:'验证身份',
		changePhone:'更改手机',
    	...
    	devices:'设备集合',
    	deviceNodes:'设备节点集合',
    	devicePortType:'设备端口类型集合',
    	deviceTypes:'设备类型集合',
    	devicePosition:'设备机房位置集合',
    	deviceRack:'设备机柜集合',
    	tenantName:'租户名称',
    	province:'省份',
    	city:'地级市',
